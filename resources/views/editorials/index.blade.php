...
@section("contenido")
<a href="{{route('editoriales.create')}}" class="btn btn-success">+ Insertar</a>
...
<thead>
	...
	@foreach($editorials as $editorial)
		<tr data-id="{{$editorial->id}}">
			<td>{{$editorial->nombre}}</td>
            <td><img class='btn_borrar' width="32px" src="https://image.flaticon.com/icons/png/512/1017/1017479.png"></td>
			<td><a href='{{"editoriales/$editorial->id/edit"}}'><img class='btn_editar' width="32px" src="https://static.vecteezy.com/system/resources/previews/001/204/710/non_2x/pencil-png.png"></a></td>
        </tr>
